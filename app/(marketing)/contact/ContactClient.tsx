...
import { submitMarketingLead } from "../_actions/marketing-actions";
...
export function ContactClient() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const result = await submitMarketingLead(formData);
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    ...
                    <h1 className="text-5xl sm:text-7xl font-black tracking-tighter text-foreground mb-8">
                        Let's build the future of <span className="text-primary italic">A-Integrity.</span>
                    </h1>
                    ...
                    <div className="grid gap-6">
                        {contactMethods.map((method, idx) => (
                            <Link
                                key={method.title}
                                href={method.href}
                                className="group flex items-start gap-4 p-6 rounded-3xl bg-card border border-border backdrop-blur-md transition-all hover:bg-accent/40 hover:border-primary/20 shadow-sm"
                            >
                        ...
                        <div className="flex gap-4">
                            {[Twitter, Github, Linkedin].map((Icon, i) => (
                                <Link
                                    key={i}
                                    href="#"
                                    className="h-10 w-10 rounded-xl bg-card border border-border flex items-center justify-center text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary hover:border-primary/20"
                                >
                ...
                >
                    ...
                    <div className="rounded-[2.5rem] bg-card border border-border p-8 md:p-12 backdrop-blur-2xl shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="h-14 rounded-2xl bg-background/50 border-border px-6 focus-visible:ring-primary/20"
                                    />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    className="min-h-[160px] rounded-3xl bg-background/50 border-border p-6 focus-visible:ring-primary/20 resize-none"
                                />
                            </div>
                    ...
                    <div className="mt-8 p-6 rounded-3xl bg-accent/40 border border-border flex items-center gap-4">
